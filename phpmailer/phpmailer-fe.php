...
if(!function_exists('preg_match_replace'))   { function preg_match_replace($pattern, $replacement, $string) { return preg_replace('/'.$pattern.'/i', $replacement, $string); } }
...
if (!isset($recipient)) {
  ...
  $recipient = preg_match_replace($email_bad_array,'',$recipient);
...
if (!isset($cc)) {
  ...
  $cc = preg_match_replace($email_bad_array,'',$cc);
  $cc = str_replace(';', ' ', $cc);
  $cc = str_replace(' ', '', $cc);
}
...
if (!isset($bcc)) {
  ...
  $bcc = preg_match_replace($email_bad_array,'',$bcc);
  $bcc = str_replace(';', ' ', $bcc);
  $bcc = str_replace(' ', '', $bcc);
}
...
if (!isset($subject)) {
  ...
  $subject = preg_match_replace($email_bad_array,'',$subject);
